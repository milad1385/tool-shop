...
export const sellerQuestions = [
  {
    id: 1,
    question: "ثبت نام به عنوان فروشنده در دیجی کالا به چه معناست؟",
    answer:
      "با تکمیل ثبت نام، پنل آنلاین فروشگاهی از دیجی کالا دریافت می کنید که می توانید کالاهای خود را به صورت آنلاین به تمام نقاط ایران به فروش برسانید. کار با این پنل بسیار ساده است و اصلا نیاز به تخصص خاصی ندارد.",
  },
  {
    id: 2,
    question: "در مراحل ثبت نام خطای تکراری بودن شماره ملی را دریافت میکنم.",
    answer:
      "شما با یک شماره ملی تنها یک بار می توانید در پنل فروشندگان دیجی کالا ثبت نام نمایید . وقتی خطای تکراری بودن شماره ملی را دریافت میکنید به این معنا است که شما یک ثبت نام نیمه کاره دارید. لطفا برای تکمیل ثبت نام قبلی خود اینجا کلیک نمایید و با هماان ایمیل و پسورد قبلی ثبت نام خود را تکمیل نمایید.",
  },
  {
    id: 3,
    question: "برای ثبت نام در دیجی کالا به چه مدارکی نیاز است؟",
...
شماره موبایل`,
  ...
  },
  {
    ...
    answer:
      "بعد از تایید ثبت نام یک کلاس آموزشی رایگان برای شما برگزار می گردد و مدیریت صحیح پنل به شما آموزش داده می شود. این اطمینان به شما داده میشود در صورت مدیریت صحیح پنل همکاری بسیار خوبی با دیجی کالا خواهید داشت. لازم به ذکر است تا قبل از آغاز اولین فروش هیچ گونه تعهد قانونی شامل حال شما نمی شود.",
  },
  {
    id: 7,
