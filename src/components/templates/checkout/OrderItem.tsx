...
function OrderItem() {
  return (
    <div className="bg-gray-100 flex-grow overflow-hidden relative rounded-3xl p-4 flex flex-col md:flex-row items-center justify-center mb-4 gap-y-6 gap-x-14">
