...
import { createMenuSchema, TMenuSchema } from "@/validators/frontend/menu.validator";
...
function CreateMenu() {
  ...
  const createMenuHandler = (data: TMenuSchema) => {
    console.log(data);
  };
  return (
    <form
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
        ...
        <Input
          ...
          className="!bg-gray-50"
          options={[
            { id: 1, label: "منو اول", value: "menu1" },
            { id: 2, label: "منو دوم", value: "menu2" },
          ]}
          label="منو پرنت"
          disable={false}
          labelClassName="!text-lg font-Iran"
